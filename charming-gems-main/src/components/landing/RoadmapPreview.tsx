        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground text-lg">
              Based on the Financial Hierarchy of Needs, NextStep guides you through each stage of financial maturity—from stability to wealth building.
            </p>
            ...
            <div className="loss-alert">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm mb-1">Opportunity Cost Alert</p>
                  <p className="text-sm text-muted-foreground">
                    By keeping ₪15,000 in your checking account instead of investing, you're missing out on <span className="gradient-text-accent font-bold">₪450/month</span> in potential returns.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="glass-card-elevated p-8">
            <h3 className="font-display text-lg font-semibold mb-6">Your Progress</h3>
