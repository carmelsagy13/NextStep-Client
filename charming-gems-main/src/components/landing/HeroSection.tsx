      ...
      <div className="container relative z-10 max-w-6xl mx-auto">
        <div className="text-center space-y-8">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 glass-card text-sm animate-fade-in">
            ...
            <span className="text-muted-foreground">AI-Powered Financial Guidance</span>
          </div>
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: '0.1s' }}>
            Stop letting your money sit idle. NextStep transforms financial paralysis into actionable progress with personalized roadmaps tailored to your goals.
          </p>
          ...
          {/* Trust indicators */}
          <div className="flex flex-wrap justify-center gap-8 pt-12 animate-fade-in" style={{ animationDelay: '0.4s' }}>
