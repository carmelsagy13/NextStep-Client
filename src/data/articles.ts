export interface Article {
  ...
  title: string;
  excerpt: string;
  /** Short, actionable takeaway tip shown in quick-tip surfaces. */
  summary: string;
  content: string;
  category: string;
  readTime: number;
...
export const articles: Article[] = [
  // Investing Basics
  {
    ...
    summary: "התחילו להשקיע מוקדם ובסכומים קטנים – אפילו ₪100 בחודש צומחים משמעותית לאורך זמן.",
...
התחילו בקטן ולמדו תוך כדי תנועה. פלטפורמות רבות מאפשרות להתחיל להשקיע כבר מ-₪100. המפתח הוא להתחיל מוקדם ולהתמיד.`,
  ...
  },
  {
    ...
    summary: "ככל שתתחילו מוקדם יותר, ריבית דריבית עובדת לטובתכם – כל שנה של דחייה עולה לכם אלפי שקלים בעתיד.",
...
ככל שתתחילו מוקדם יותר, כך יהיה לריבית דריבית יותר זמן לפעול. התחלה בגיל 25 לעומת 35 יכולה להסתכם בהפרש של מאות אלפי שקלים עד הפרישה.`,
  ...
  },
  {
    ...
    summary: "אל תשימו את כל הביצים בסל אחד – פיזור בין אפיקים שונים מקטין סיכון בלי לוותר על צמיחה.",
...
קחו בחשבון את הגיל שלכם, המטרות הפיננסיות שלכם והנוחות הרגשית שלכם עם תנודות בשוק כשאתם קובעים את רמת הסיכון המתאימה לכם.`,
  ...
  // Emergency Funds
  {
    ...
    summary: "שמרו בצד הוצאות מחיה של 3 עד 6 חודשים בחשבון נזיל ונפרד – זו רשת הביטחון שלכם.",
...
התחילו עם יעד של ₪5,000, ואז התקדמו עד לחודש שלם של הוצאות. הגדירו הפקדה אוטומטית כדי שהחיסכון יהיה ללא מאמץ.`,
  ...
  },
  {
    ...
    summary: "החזיקו את קרן החירום בחשבון נפרד מהחיסכון המתוכנן כדי לא להתפתות לגעת בה.",
...
ניהול חשבונות נפרדים למטרות שונות עוזר לכם להימנע מלגעת בקרן החירום עבור הוצאות שאינן חירום.`,
  ...
  // Pension & Retirement
  {
    ...
    summary: "בדקו שמפרישים עבורכם את מלוא ההפרשות הפנסיוניות (כ-18.5% מהשכר) ונצלו את הטבות המס.",
...
הפקדות לפנסיה מזכות בהטבות מס עד תקרות מסוימים. נצלו אותן כדי למקסם את החיסכון שלכם.`,
  ...
  },
  {
    ...
    summary: "בדקו פעם בשנה את החיסכון הפנסיוני שלכם ועדכנו את היעדים – התחלה מוקדמת מכפילה את הסכום הסופי.",
...
4. בדקו ועדכנו מדי שנה`,
  ...
  // Budgeting Tips
  {
    ...
    summary: "חלקו את ההכנסה: 50% לצרכים, 30% לרצונות ו-20% לחיסכון – והפכו את החיסכון לאוטומטי.",
...
4. הפכו את החיסכון לאוטומטי`,
  ...
  },
  {
    ...
    summary: "עקבו חודש אחד אחר כל ההוצאות שלכם – רק כך תזהו לאן הכסף בורח ואיפה אפשר לחסוך.",
...
קבעו מועד שבועי או חודשי לסקירת ההוצאות. חפשו דפוסים ותחומים לייעול.`,
  ...
  // Financial Literacy
  {
    ...
    summary: "בנו קודם יסוד ובטחון (תקציב וקרן חירום) ורק אז עברו להשקעות – כל שלב תומך בבא אחריו.",
...
אל תמהרו לשלבים גבוהים לפני שביססתם את היסוד. כל שלב תומך בשלבים שמעליו.`,
  ...
  },
  {
    ...
    summary: "זכרו את הנוסחה הבסיסית: שווי נקי = נכסים פחות התחייבויות – זה המספר שחשוב להגדיל.",
...
- **בטוחה**: נכס המשמש להבטחת הלוואה`,
  ...
  // Market Insights
  {
    ...
    summary: "התעלמו מהרעש היומי בשוק והתמקדו במגמות לטווח ארוך – זו הדרך לבנות הון בביטחון.",
