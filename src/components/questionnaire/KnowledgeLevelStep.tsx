...
const experienceLevels = [
  {
    ...
    description: "I've never invested before",
  },
  {
    value: "basic",
  ...
  },
  {
    value: "intermediate",
    label: "Intermediate",
    description: "I've made some investments",
  },
  {
    value: "advanced",
    label: "Advanced",
...
export function KnowledgeLevelStep({
  initialData,
  onComplete,
  onBack,
}: KnowledgeLevelStepProps) {
  const [investmentExperience, setInvestmentExperience] = useState(
    initialData?.investmentExperience || "",
  );
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex gap-3">
        <Button onClick={onBack} className="flex-1 h-12" size="lg">
